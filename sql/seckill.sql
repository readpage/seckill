...
-- ----------------------------
INSERT INTO `goods_seckill` VALUES (1, 123, 8, '2021-05-22 17:22:52', '2021-05-22 18:23:00');
...
CREATE TABLE `order`  (
  ...
  `status` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '订单状态，0新建未支付，1已支付，2已发货，3已收货，4已退款，5已完成',
...
-- Records of order
-- ----------------------------
INSERT INTO `order` VALUES (1, NULL, NULL, NULL, 1, 1);
...
CREATE TABLE `user_info`  (
  `id` int(0) UNSIGNED NOT NULL COMMENT '用户id',
...
-- ----------------------------
INSERT INTO `user_info` VALUES (1, NULL, '2018-05-21 21:10:21', '2018-05-21 21:10:25', 1);
INSERT INTO `user_info` VALUES (2, NULL, '2018-05-21 21:10:21', '2018-05-21 21:10:25', 1);
