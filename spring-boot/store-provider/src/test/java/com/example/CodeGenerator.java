...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir")+ "/store-provider";
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/seckill?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8");
